// ============================================================
// Materis5.jsx — マテリス5：頂点カラー
// 2枚のslab + 白い半球目 + 縦長黒六角形瞳
// マテリアル: vertexColors:true / shininess:120 / 赤↔青グラデーション
// Usage:
//   import { createMateris5 } from './Materis5.jsx';
//   const obj = createMateris5();  // THREE.Group
//   scene.add(obj);
// ============================================================
...
function _applyVertexColors(geo, yMin, yMax) {
  const pos = geo.attributes.position;
  const colors = new Float32Array(pos.count * 3);
  const c = new THREE.Color();
  const top    = new THREE.Color(0xff2222);
  const bottom = new THREE.Color(0x2244ff);
...
export function createMateris5() {
  const slabMat = new THREE.MeshPhongMaterial({
    vertexColors: true, flatShading: true,
    shininess: 120, specular: 0x999999,
  });
...
export default function Materis5Preview() {
  ...
  return (
    <div style={{ width: '100%', height: '100vh', position: 'relative' }}>
      ...
      <div style={{
        ...
        🎨 <strong>Materis5</strong> — 頂点カラー<br />
