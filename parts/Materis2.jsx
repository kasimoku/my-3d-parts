// ============================================================
// Materis2.jsx — マテリス2：ツルツル
// 2枚のslab + 白い半球目 + 縦長黒六角形瞳
// マテリアル: ダークグレー(0x333333) / flatShading / shininess:120
// Usage:
//   import { createMateris2 } from './Materis2.jsx';
//   const obj = createMateris2();  // THREE.Group
//   scene.add(obj);
// ============================================================
...
export default function Materis2Preview() {
  ...
  return (
    <div style={{ width: '100%', height: '100vh', position: 'relative' }}>
      ...
      <div style={{
        ...
        🪞 <strong>Materis2</strong> — ツルツル<br />
